    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hotel_name",
                    models.CharField(max_length=122, null=True, verbose_name="Name"),
                ),
                (
                    "cover_image",
                    models.ImageField(
                        null=True,
                        upload_to="tour_package_images",
                ...
                (
                    "link",
                    models.URLField(
                        blank=True, default="#", null=True, verbose_name="Hotel Link"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "package_cover_image",
                    models.ImageField(
                        blank=True, null=True, upload_to="tour_package_cover_images"
                    ),
                ),
                ...
                (
                    ...
                    models.FloatField(
                        default=50,
                        help_text="Enter 50 percent children traveler",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.FloatField(
                        default=90,
                        help_text="Enter 90 percent infant traveler",
                        null=True,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
